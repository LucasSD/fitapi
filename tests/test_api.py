...
def test_get_all_daily_and_ordering(test_client):
    ...
    expected_json = [{'endDate': '1984-01-02T00:00:00','startDate': '1984-01-01T00:00:00'},{'endDate': '1985-01-02T00:00:00','startDate': '1985-01-01T00:00:00'}]
...
def test_get_one_valid_daily(test_client):
    ...
    assert response.status_code == 200
    expected_json = {'endDate': '1984-01-02T00:00:00', 'startDate': '1984-01-01T00:00:00'}
    assert response.json == expected_json
